...
from utils.GeneralUtils import load_json
from utils.MiscRegionUtils import numpy2vips
from configs import panoptic_model_configs as cfg
...
class MutilsMaskVisualizer(object):
    ...
    def _maybe_prep_girder_client(self):
        ...
        from configs.HistomicsAPIConfigs import StyxAPI
