...
from histolab.src.histolab.tiler import ScoreTiler
from histolab.src.histolab.types import CoordinatePair
from histolab.src.histolab.masks import BiggestTissueBoxMask
from histolab.src.histolab.filters.image_filters_functional \
...
class MuTILsWSIRunner(MutilsInferenceRunner):
    ...
    def _create_slide_dirs(self):
        ...
        for condition, dirname in (
                ...
                (True, 'roiVis'), # Always create 'roiVis'
...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--subsets', type=int, default=[9], nargs='+')
